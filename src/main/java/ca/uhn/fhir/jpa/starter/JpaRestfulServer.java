...
import ca.uhn.fhir.jpa.starter.interceptor.OEForwardingInterceptor;
...
public class JpaRestfulServer extends RestfulServer {
    ...
    protected void initialize() throws ServletException {
        ...
        OEForwardingInterceptor forwardingInterceptor = new OEForwardingInterceptor(ctx);
        getInterceptorService().registerInterceptor(forwardingInterceptor);
